...
#ifndef SALTPACK_ALPHABETS_H
#define SALTPACK_ALPHABETS_H
...
namespace saltpack {
    ...
    const std::string BASE85 = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstu";
}

#endif //SALTPACK_ALPHABETS_H
